...
- **Task 4: Publish and verify only explicitly approved repairs.** Status: active for only the confirmed exact 4BD durability slice through work block 4BD-R.

### Confirmed Work Block 4BD-R: Installed-PWA Browser-Coverage Durability

Status: active; confirmed on 2026-07-24.
