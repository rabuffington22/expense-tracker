...
- **Task 1N: Repair planning, Weekly, and Waterfall calculation truthfulness.** Status: current for a separately confirmed planning pass after the planning route guard; no implementation is authorized.
