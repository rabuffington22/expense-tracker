...
- **Task 1P: Resolve the remaining public, mobile, browser-hardening, availability, and operator-clarity findings.** Status: active and decomposed into the execution-sized tasks below; Tasks 1P.4.1, 1P.4.2a, and both Task 1P.4.2b migration slices are complete and durable, with Task 1P.4.2b.2 automatically deployed and credential-free health verified through 4AH-R; later slices remain separately gated.
