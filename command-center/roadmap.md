...
- **Task 4: Publish and verify only explicitly approved repairs.** Status: done through 4BL-R for the exact browser-CI foundation with zero workflows and no deployment; every future publication or execution remains separately gated.
