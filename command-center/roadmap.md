...
Status: active; work block 4AD-R is the confirmed publication block and Task 1P.4 remains the next separate planning gate
...
- **Task 1P: Resolve the remaining public, mobile, browser-hardening, availability, and operator-clarity findings.** Status: active and decomposed into the execution-sized tasks below; Task 1P.3 is complete locally and Task 1P.4 is the next planning gate.
