...
- **Task 4: Publish and verify only explicitly approved repairs.** Status: complete through 4BB-R for every explicitly released repair to date; every future publication remains separately gated.
