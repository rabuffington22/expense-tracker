...
- **Task 4: Publish and verify only explicitly approved repairs.** Status: complete through 4AY-R for every explicitly released repair to date; 4AZ and every future publication remain separately gated.
