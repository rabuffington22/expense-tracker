...
- **Task 2: Polish high-friction journeys without widening financial or authentication risk.** Status: active umbrella; decomposed into Tasks 2.1-2.8 after 5B intake.
  ...
  - **Task 2.4: Revise the recurring-charge surface.** Status: Ryan-decision. Decide whether the surface is a cancellation watchlist, complete recurring-spend register, or combined workflow before revising its name, order, progress, labels, and undo behavior.
...
Status: active on `codex/phase-5-usability-baseline` after Ryan confirmed the exact production-release checkpoint.
