...
- **Task 4: Publish and verify only explicitly approved repairs.** Status: current only for the separate 4BR Phase 4 Completion Reconciliation decision after 4BQ made Fly deployment inputs deterministic and passed one clean zero-annotation automatic deployment plus credential-free health.
