...
After 4AZ, the application-owned style inventory reconciles exactly to zero style blocks, zero template attributes, zero generated attributes, and zero runtime writes. Header generation, nonce plumbing, exceptional-document and Plaid third-party policy, final enforcement, and live or publication work remain separate.
