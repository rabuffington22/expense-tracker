...
| P3-3J-06 | Medium | partly-addressed | High | Session cookie and browser security policy | 4AC makes the session cookie explicit and 4AE freezes a strict core/narrow Plaid CSP contract plus migration and proof slices; protected HTML still lacks CSP. | Cookie policy is durable and CSP planning is complete locally; implementation, enforcement, publication, and production proof remain separate. | begin-confirmed-csp-migration-after-contract-review |
