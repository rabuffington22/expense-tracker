...
| P3-3J-06 | Medium | partly-addressed | High | Session cookie and browser security policy | 4AC makes the session cookie explicit, 4AE freezes a strict core/narrow Plaid CSP contract, 4AF completes the shared execution foundation, 4AG-R makes the dashboard/report fragment slice durable and deployed, and 4AH completes transaction/modal fragments locally; protected HTML still lacks CSP. | Cookie policy, planning, shared execution, and all directly returned fragment migrations are complete through 4AH; final HTMX disablement, page/style/header work, publication, and final production proof remain separate. | confirm-final-htmx-disablement-after-4ah |
