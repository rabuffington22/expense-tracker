...
| P3-3J-06 | Medium | partly-addressed | High | Session cookie and browser security policy | 4AC makes the session cookie explicit, 4AE freezes a strict core/narrow Plaid CSP contract, 4AF completes the shared execution foundation, 4AG-R and 4AH-R make both fragment migration slices durable and deployed, and 4AI disables HTMX eval and swapped-script processing with local cross-route proof; protected HTML still lacks CSP. | Cookie policy, planning, shared execution, and both directly returned fragment migrations are durable through 4AH-R; final HTMX disablement is complete locally through 4AI while publication, page/style/header work, and final production proof remain separate. | plan-task-1p-4-2c-after-4ai |
