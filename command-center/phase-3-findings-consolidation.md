...
One unresolved high item, `P3-3J-03`, is a Ryan product-policy decision rather than an implementation-ready defect. Nine medium coverage items remain parked and `P3-3J-C01` is resolved locally through 4BD pending separately authorized publication. Resolved items are retained for traceability but must not return to the repair candidate pool without new contrary evidence.
