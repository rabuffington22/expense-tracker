...
| P3-3J-06 | Medium | open | High | Session cookie and browser security policy | Synthetic HTTPS response lacked explicit Secure/SameSite and protected HTML lacked CSP, while production policy must be explicit and compatible with HTMX/assets. | Defense in depth against browser/session attacks is weaker than intended. | security-policy-decision-before-header-change |
