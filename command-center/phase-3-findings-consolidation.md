...
| P3-3J-06 | Medium | partly-addressed | High | Session cookie and browser security policy | 4AC makes the session cookie explicit, 4AE freezes a strict core/narrow Plaid CSP contract, and 4AF completes the shared execution foundation locally; protected HTML still lacks CSP. | Cookie policy and CSP planning are durable; shared-shell migration is locally verified; fragment/page/style/header work, publication, and production proof remain separate. | size-swapped-fragment-migration-after-4af |
