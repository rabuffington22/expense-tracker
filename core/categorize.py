...
_KEYWORD_RULES: list[tuple[list[str], str, Optional[str], float]] = [
    ...
    (["home depot", "lowes", "lowe's", "menards", "ace hardware", "ace hdwe",
      "spray paint", "lumber", "paint", "hardware", "hdwe"],
     "Home Improvement", None, 0.6),
    (["landscap", "landsculp", "lawn", "mowing", "irrigation", "grounds",
      "orkin", "pest control", "well service", "dfw security", "plumbing"],
     "Home Services", None, 0.6),
    (["mortgage", "hoa", "dovenmuehle"],
     "Mortgage", None, 0.7),
    (["rent", "landlord", "lease", "property",
    ...
    (["salary.com", "indeed", "spokeo"],
     "HR", None, 0.7),
    (["greenpage payrol", "payroll", "cypay", "cyberp"],
     "Payroll", None, 0.7),
    (["direct dep", "salary", "income", "wages", "buffington ach"],
     "Income", None, 0.7),
