...
_KEYWORD_RULES: list[tuple[list[str], str, Optional[str], float]] = [
    ...
    (["rent", "mortgage", "hoa", "landlord", "lease", "property",
     ...
     "Housing", None, 0.7),
    # ── Office / business services (before Income so salary.com → Office) ──
    (["jani king", "on-site pc", "onsite pc",
      "usps", "ups ", "fedex", "postage",
      "vistaprint", "printing", "shredding",
      "salary.com", "greenpage payrol", "sba loan",
      "iron mountain", "ironmountain", "indeed", "spokeo",
      "boostlingo", "transworld", "folds of grac", "myfico"],
     "Office", None, 0.7),
    (["payroll", "direct dep", "salary", "income", "wages", "buffington ach"],
     "Income", None, 0.7),
    # ── SaaS / software subscriptions (before general Subscriptions rule) ─
    (["adobe", "time off cloud", "digitalmarketer", "medsafe",
      "microsoft 365", "microsoft365", "google workspace",
      "quickbooks", "intuit ", "dropbox", "slack ", "zoom ",
      "modernizing medi",
      "zapier", "flexibits", "miro.com", "claude.ai",
      "otter.ai", "openrouter", "anthropic"],
     "Subscriptions", "Software", 0.8),
    (["subscription", "membership", "annual fee", "monthly fee", "saas",
      "dynastynerd", "dynasty nerd", "pffaacquisi", "pff ",
      "apple.com/bill"],
     "Subscriptions", None, 0.6),
    (["begin *homer", "begin homer"],
     "Education", None, 0.7),
    (["aes stdnt", "aes student", "student loan"],
     "Student Loans", "Ryan", 0.7),
    (["edward jones"],
     "Retirement", None, 0.7),
    (["self storage", "public storage"],
     "Storage", None, 0.6),
    (["deere credit", "kubota credit"],
     "Ranch", None, 0.7),
